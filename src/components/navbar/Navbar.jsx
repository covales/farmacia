  ...
  return (
    <div className="container">
        ...
        <div className="container ">
          ...
          <div className="collapse navbar-collapse" id="navbarCollapse">
            <ul className="navbar-nav me-auto mb-2 mb-md-0 ">
              ...
              <li className="nav-item">
                <Link className="nav-link " to="/productsale">
                  Vender
                </Link>
              </li>
            </ul>
            <div className="dropdown mx-auto">
              <a
                href="#"
                className="d-flex text-white text-decoration-none dropdown-toggle"
                id="dropdownUser1"
      ...
      <div
        className="modal fade"
        id="vendedorModal"
        aria-labelledby="vendedorLabel"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="vendedorLabel">
                Registrar vendedor
              </h5>
              <button
                type="button"
